...
export default function TOC() {
    ...
    return (
        <Nav variant="pills">
            ...
            <NavItem>
                <NavLink href="https://github.com/crohank/kambaz-next-js">React Git</NavLink></NavItem>

                 <NavItem>
                <NavLink href="https://github.com/crohank/kambaz-node-server-app">Server Git</NavLink></NavItem>
