      ...
      <Table striped>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-total-activity">11:31:32</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
          ...
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
              <span className="wd-first-name">Micheal</span>{" "}
              <span className="wd-last-name">Jordon</span>
            </td>
            <td className="wd-login-id">001234565S</td>
            <td className="wd-section">S101</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-10-12</td>
            <td className="wd-total-activity">07:21:32</td>
          </tr>
